title: javascript原生函数搜集
date: 2014/8/3 21:02:19 
tags: javascript
categories: technology

---

搜集了一些比较常用的javascript函数，总共刚好70个，货很足，以后遇到相应的就可以直接来这里拷贝了，欢迎大家收藏。
...
function setCookie(name, value, Hours) {
	...
	document.cookie = name + "=" + escape(value) + ";path=/;expires=" + exp.toGMTString() + ";domain=w3cboy.com;"
}
```
