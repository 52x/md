title: Mac 下开机启动 Aria2
date: 2015-12-13 8:51 PM
categories: 
tags: [mac,]
---
...
主要是更改了下载文档路径 `dir=/Users/alex/Downloads` 

## 添加到启动项

创建文件 `aria2.plist`

**修改array中的aria2命令为你的aria2命令路径,可使用`which aria2c`命令查看**
...
> 可以添加参数到 `<array>` 中,添加到第一行命令之后。


将文件复制到 `~/Library/LaunchAgents` 下
